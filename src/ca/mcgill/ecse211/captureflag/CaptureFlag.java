...
/**
 * CaptureFlag is the main class that instantiates all of the individual units that will be needed
 * to operate the robot. It also has constants that are used in the other classes of the project, as
 * well as static methods. This is to make sure that setting any value is consistent among all
 * classes, and that certain methods are not copied over into all of the other classes.
 */
...
public class CaptureFlag {
  ...
  public static void main(String[] args) {
    ...
    GameController gc = new GameController(rightMotor, leftMotor, sensorMotor, odometer, lightLocal,
        usLocal, lp, usPoller, nav, conn, flag);
  ...
  /**
   * Prints to the screen a menu for setting the travel to points for the ZipLine lab, as well as a
   * menu for choosing either rising or falling edge localization.
   */
  ...
  /**
   * Prints to the screen a menu for setting the travel to points for the ZipLine lab. For setting
   * the points, the used can push the up or down buttons to change the value of the displayed
   * value. When the user wants submit the value, the enter button should be pressed.
   * 
  ...
  /**
   * This method converts a distance into a number of rotations the motor should complete to go the
   * distance.
   * 
   * @param radius The radius of the robots wheel.
   * @param distance The desired distance that the robot should travel.
   * @return An integer representing the amount of rotations the robot should turn to go the given
   *         distance.
   */
  ...
  /**
   * This method converts a given angle into a number of rotations the motor should complete to
   * rotate the angle. Uses the convertDistance method.
   * 
   * @param radius The radius of the robots wheel.
   * @param TRACK The track length, in cm, of the robot.
   * @param angle The angle that should be turned, in degrees.
   * @return An integer representing the amount of rotations the robot should turn to go turn the
   *         given angle.
   */
