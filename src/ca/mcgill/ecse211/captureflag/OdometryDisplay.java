...
/**
 * This class instantiates a thread to create a UI of odometer position and orientation readings on
 * the LCD screen of the Lego EV3 brick
 * 
 */
public class OdometryDisplay extends Thread {
  ...
  /**
   * This method converts any double data type to a string that can be easily read off the LCD
   * screen
   * 
